...
class BeershopOwner(User):
    address = CharField(_("Address of Shop"), blank=True, max_length=255)
    latitude = CharField(_("Latitude of Shop"), blank=True, max_length=255)
    longtidue = CharField(_("Longtitude of Shop"), blank=True, max_length=255)
    phone_num = CharField(_("PhoneNumber of Shop"), blank=True, max_length=255)
    homepage = CharField(_("Homepage of Shop"), blank=True, max_length=255)
    customers_counting = CharField(_("Customers of Shop"), blank=True, max_length=255)
